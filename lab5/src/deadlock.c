//Как пример дедлока рассмотрим задачу обедающих философов. Эта задача была придумана Дейкстрой 
//и сформулирована в современном виде Хaаром для описания типичных проблем многопоточной среды.
